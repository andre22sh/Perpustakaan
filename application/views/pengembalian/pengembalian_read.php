...
<?php endif; ?>
<a href="<?php echo site_url('pengembalian/insert');?>" class="btn btn-primary float-right">Tambah</a>
<br /><br />
...
<a href="<?php echo site_url('pengembalian/export');?>" class="btn btn-success float-right">Export Data</a>
