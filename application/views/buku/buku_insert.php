<form method="post" action="<?php echo site_url('buku/insert_submit/');?>" enctype="multipart/form-data">
	<table class="table table-striped">
		<tr>
			<td>ID Buku</td>
			<td><input type="text" name="id_buku" value="" required="" class="form-control"></td>
		</tr>
		<tr>
			<td>Nama Buku</td>
			<td><input type="text" name="nama_buku" value="" required="" class="form-control"></td>
		</tr>
		<tr>
			<td>Kategori</td>
			<td>
        ...
        <tr>
			<td>Jumlah Buku</td>
			<td><input type="text" name="jumlah_buku" value="" required="" class="form-control"></td>
		</tr>
		
        <tr>
			<td>Cover Buku</td>
			<td><input type="file" name="gambar" size="20" value="" required="" class="form-control"></td>
		</tr>
